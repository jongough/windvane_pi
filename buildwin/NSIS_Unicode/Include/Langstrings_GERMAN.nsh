...
LangString LangDialog_Title ${LANG_GERMAN} "OpenCPN 4.4.0 Installation"
...
LangString Uninstall_Link ${LANG_GERMAN} "OpenCPN 4.4.0 deinstallieren"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_GERMAN} "OpenCPN 4.4.0 ist bereits installiert.$\r$\nWählen Sie aus, wie Sie OpenCPN installieren möchten."	
...
LangString Finish_Link_URL ${LANG_GERMAN} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=4.4.0"
...
LangString ^NameDA ${LANG_GERMAN} "OpenCPN Version 4.4.0"
