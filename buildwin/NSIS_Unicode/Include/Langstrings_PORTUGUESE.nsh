...
LangString LangDialog_Title ${LANG_PORTUGUESE} "OpenCPN 4.4.0 Installation"
...
LangString Uninstall_Link ${LANG_PORTUGUESE} "Uninstall OpenCPN 4.4.0"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_PORTUGUESE} "OpenCPN 4.4.0 is already installed.$\r$\nChoose how you want to install OpenCPN."
...
LangString Label_TypeInst_Reinstall_Text ${LANG_PORTUGUESE} "OpenCPN 4.4.0 is already installed on your system. You can reinstall the version now using the previous settings. If you wish to install the program with different settings, cancel installation and un-install the existing version first. Click Next to continue."
...
LangString Finish_Link_URL ${LANG_PORTUGUESE} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=4.4.0"
...
LangString ^NameDA ${LANG_PORTUGUESE} "OpenCPN versão 4.4.0"
