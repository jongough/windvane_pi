...
LangString LangDialog_Title ${LANG_FRENCH} "OpenCPN 4.4.0 Installation"
...
LangString Uninstall_Link ${LANG_FRENCH} "Désinstalle  OpenCPN 4.4.0"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_FRENCH} "OpenCPN 4.4.0 est déjà installé.$\r$\nChoisir comment vous voulez installer OpenCPN."
...
LangString Finish_Link_URL ${LANG_FRENCH} "http://opencpn.info/?ref=installer&utilisateurr=$USERS_NAME&lang=$REG_LANG&version=4.4.0"
...
LangString ^NameDA ${LANG_FRENCH} "OpenCPN Version 4.4.0"
