...
//|
//| CLASS:
//|    WindvaneInstrument_Dial
//|
//| DESCRIPTION:
//|    This class creates a speedometer style control
//|
//+------------------------------------------------------------------------------
class WindvaneInstrument_Dial: public WindvaneInstrument
{
      public:
            WindvaneInstrument_Dial( wxWindow *parent, wxWindowID id, wxString title, int cap_flag,
                        int s_angle, int r_angle, int s_value, int e_value);

            ~WindvaneInstrument_Dial(void){}
