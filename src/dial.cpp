...
WindvaneInstrument_Dial::WindvaneInstrument_Dial( wxWindow *parent, wxWindowID id, wxString title, int cap_flag,
                  int s_angle, int r_angle, int s_value, int e_value) : WindvaneInstrument(parent, id, title, cap_flag)
{
...
wxSize WindvaneInstrument_Dial::GetSize( int orient, wxSize hint )
{
      wxClientDC dc(this);
      int w;
...
void WindvaneInstrument_Dial::SetData(int st, double data, wxString unit)
{
...
void WindvaneInstrument_Dial::Draw(wxGCDC* bdc)
{
    wxColour c1;
...
void WindvaneInstrument_Dial::DrawFrame( wxGCDC* dc )
{
    wxSize size = GetClientSize();
    wxColour cl;
...
void WindvaneInstrument_Dial::DrawMarkers(wxGCDC* dc)
{
...
void WindvaneInstrument_Dial::DrawLabels(wxGCDC* dc)
{
...
void WindvaneInstrument_Dial::DrawBackground(wxGCDC* dc)
{
      // Nothing to do here right now, will be overwritten
      // by child classes if required
}

void WindvaneInstrument_Dial::DrawData(wxGCDC* dc, double value,
...
void WindvaneInstrument_Dial::DrawForeground(wxGCDC* dc)
{
